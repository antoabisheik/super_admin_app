...
const SignUpForm = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://webapps-middleware.onrender.com/api/auth/signup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      const res = await fetch("https://webapps-middleware.onrender.com/api/SSauth/google-login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({ idToken }),
